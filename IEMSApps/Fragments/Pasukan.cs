...
namespace IEMSApps.Fragments
{
    public class Pasukan : Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = inflater.Inflate(Resource.Layout.PasukanLayout, container, false);
            return view;
        }
        ...
        private void SetInit()
        {
            try
            {
                ...
                var txtIdPasukan = View.FindViewById<TextView>(Resource.Id.txtIdPasukan);
                var txtKetuaPasukan = View.FindViewById<TextView>(Resource.Id.txtKetuaPasukan);
                ...
                _lvResult = View.FindViewById<ListView>(Resource.Id.lView);


                LoadListPasukanAhli();

                var imgAdd = View.FindViewById<ImageView>(Resource.Id.imgAdd);
        ...
        {
            _listPasukanAhli = PasukanBll.GetListPasukanAhliByUserQuery();

            _lvResult.Adapter = new PasukanAhliAdapter(this.Activity, this, _listPasukanAhli);
        ...
        private void ImgAdd_Click(object sender, System.EventArgs e)
        {
            try
            {
                _hourGlass?.StartMessage(this.Activity, OnAddPasukanAhli);
            }
            catch (Exception ex)
            {
        ...
        private void OnAddPasukanAhli()
        {
            ...
            var view = this.Activity.LayoutInflater.Inflate(Resource.Layout.TambahAhliPasukanModal, null);
            ...
            btnOk.Click += (sent, args) =>
            {
                try
                {
                    ...
                    if (response.Success)
                    {
                        GeneralAndroidClass.ShowModalMessage(this.Activity, Constants.Messages.SuccessSavePasukan);
                        LoadListPasukanAhli();
                    }
                    else
                    {
                        var _alertDialog = GeneralAndroidClass.GetDialogCustom(this.Activity);
        ...
        private void SetAutoCompliteAdapter(bool basedCawanganUser)
        {
            ...
            actCarian.Adapter = new ArrayAdapter<string>(this.Activity, Resource.Layout.support_simple_spinner_dropdown_item, listPengguna);
        ...
        private void ShowHapusPasukan(string noKp)
        {
            ...
            var builder = new AlertDialog.Builder(this.Activity).Create();
            var view = this.Activity.LayoutInflater.Inflate(Resource.Layout.HapusAlihPasukanModal, null);
            builder.SetView(view);
        ...
        private void SetCawanganDefaultAndAdapter()
        {
            ...
            actCawangan.Adapter = new ArrayAdapter<string>(this.Activity,
        ...
        private void SetPenguatKuasaDefaultAndAdapter()
        {
            ...
            actPenguatkuasaan.Adapter = new ArrayAdapter<string>(this.Activity, Resource.Layout.support_simple_spinner_dropdown_item, listPengguna.Select(c => c.Value).ToList());
            if (listPengguna.Any())
