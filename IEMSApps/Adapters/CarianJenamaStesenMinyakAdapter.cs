...
{
    public class CarianJenamaStesenMinyakAdapter : BaseAdapter<JenamaStesenMinyakDto>
    {
        private readonly List<JenamaStesenMinyakDto> _items;
        private readonly Activity _context;

        public CarianJenamaStesenMinyakAdapter(Activity activity, List<JenamaStesenMinyakDto> premisDtos)
        {
            _context = activity;
            _items = premisDtos;
        }

        public override JenamaStesenMinyakDto this[int position] => _items[position];
        ...
        private class ViewHolder : Java.Lang.Object
        {
            ...
            public void Bind(JenamaStesenMinyakDto data)
            {
