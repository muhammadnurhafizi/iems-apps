...
{
    public class CarianAsasTindakanMultipleAdapter : BaseAdapter<AsasTindakanDto>
    {
        private readonly List<AsasTindakanDto> _items;
        private readonly Activity _context;

        public CarianAsasTindakanMultipleAdapter(Activity activity, List<AsasTindakanDto> listData)
        {
            _context = activity;
            _items = listData;
        }

        public override AsasTindakanDto this[int position] => _items[position];
        ...
        private class ViewHolder : Java.Lang.Object
        {
            ...
            public void Bind(AsasTindakanDto data)
            {
