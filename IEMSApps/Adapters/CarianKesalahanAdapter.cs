...
{
    public class CarianKesalahanAdapter : BaseAdapter<KesalahanDto>
    {
        private readonly List<KesalahanDto> _items;
        private readonly Activity _context;

        public CarianKesalahanAdapter(Activity activity, List<KesalahanDto> listData)
        {
            _context = activity;
            _items = listData;
        }

        public override KesalahanDto this[int position] => _items[position];
        ...
        private class ViewHolder : Java.Lang.Object
        {
            ...
            public void Bind(KesalahanDto data)
            {
