...
namespace IEMSApps.Adapters
{
    ...
    public class CarianBandarPenerimaAdapter : BaseAdapter<BandarPenerimaDto>
    {
        private readonly List<BandarPenerimaDto> _items;
        private readonly Activity _context;

        public CarianBandarPenerimaAdapter(Activity activity, List<BandarPenerimaDto> premisDtos)
        {
            _context = activity;
            _items = premisDtos;
        }

        public override BandarPenerimaDto this[int position] => _items[position];
        ...
        private class ViewHolder : Java.Lang.Object
        {
            ...
            public void Bind(BandarPenerimaDto data)
            {
