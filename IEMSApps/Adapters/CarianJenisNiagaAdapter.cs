...
{
    public class CarianJenisNiagaAdapter : BaseAdapter<JenisNiagaDto>
    {
        private readonly List<JenisNiagaDto> _items;
        private readonly Activity _context;

        public CarianJenisNiagaAdapter(Activity activity, List<JenisNiagaDto> premisDtos)
        {
            _context = activity;
            _items = premisDtos;
        }

        public override JenisNiagaDto this[int position] => _items[position];
        ...
        private class ViewHolder : Java.Lang.Object
        {
            ...
            public void Bind(JenisNiagaDto data)
            {
