...
{
    public class CarianMaklumatChargelineAdapter : BaseAdapter<MaklumatChargelineDto>
    {
        private readonly List<MaklumatChargelineDto> _items;
        private readonly Activity _context;

        public CarianMaklumatChargelineAdapter(Activity activity, List<MaklumatChargelineDto> premisDtos)
        {
            _context = activity;
            _items = premisDtos;
        }

        public override MaklumatChargelineDto this[int position] => _items[position];
        ...
        private class ViewHolder : Java.Lang.Object
        {
            ...
            public void Bind(MaklumatChargelineDto data)
            {
                lblNama.Text = data.pejabat;
