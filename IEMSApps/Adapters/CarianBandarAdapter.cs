...
namespace IEMSApps.Adapters
{
    ...
    public class CarianBandarAdapter : BaseAdapter<BandarDto>
    {
        private readonly List<BandarDto> _items;
        private readonly Activity _context;

        public CarianBandarAdapter(Activity activity, List<BandarDto> premisDtos)
        {
            _context = activity;
            _items = premisDtos;
        }

        public override BandarDto this[int position] => _items[position];
        ...
        private class ViewHolder : Java.Lang.Object
        {
            ...
            public void Bind(BandarDto data)
            {
